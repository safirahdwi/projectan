...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="afterlogin.php">Smart PPKU</a>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>Welcome TO Smart PPKU</strong>
            </h1>
            <hr>
          </div>
          <!-- <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">Anda ingin IPK tinggi? kuy!</p>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="login.php">Masuk</a>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="register.php">Daftar</a>
          </div> -->
        </div>
      </div>
    </header>
